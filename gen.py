...
def tri_table_gen(cube_index, edge):
  try:
    return TRI_TABLE[cube_index].index(edge)
  except:
    return -1

def print_tri_table_things():
  for cube_index in xrange(256):
    print "{",
    for edge in xrange(12):
      print tri_table_gen(cube_index, edge), ",",
    print "},"
...
def print_offset_dirs():
  for ind, dirs in EDGE_OFFSET_DATA.items():
    print "{",
